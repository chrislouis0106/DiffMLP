...
from src.rl.graph_search.diff_pn import DiffMLPPolicy
from src.rl.graph_search.diff_pg import DiffPolicyGradient
...
def initialize_model_directory(args, random_seed=None):
    ...
    if args.model.startswith('diffmlp'):
        hyperparam_sig = '{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}-{}'.format(
            ...
            args.diff_T_max,
            args.diff_num_layers,
        )
    elif args.model in ['rule']:
        hyperparam_sig = '{}-{}-{}-{}-{}-{}-{}-{}-{}-{}'.format(
            args.baseline,
            args.entity_dim,
            args.relation_dim,
...
def construct_model(args):
    ...
    if args.model in ['diffmlp', 'diffmlp.gc']:
        pn = DiffMLPPolicy(args)
        lf = DiffPolicyGradient(args, kg, pn)
    elif args.model in ['point', 'point.gc']:
